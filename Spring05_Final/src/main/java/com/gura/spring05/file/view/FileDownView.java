 ...
 */
@Component("fileDownView")//컴퍼넌트 스캔을 통해서 얘도 bean 이 된다. spring framework 에서 관리한다.//bean 의 이름은 유일해야 된다.
public class FileDownView extends AbstractView{
	...
	protected void renderMergedOutputModel(Map<String, Object> model, HttpServletRequest request,
		...
		//ModelAndView 객체에 .addObject() 해서 담은 객체는 model에 들어 있다.
