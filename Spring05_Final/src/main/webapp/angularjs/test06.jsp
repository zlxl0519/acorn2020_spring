...
<script>
	...
	// 모듈일 이용해서 yourCtrl 이라느 이름의 컨트롤러 만들기
...
<body ng-app="myApp">
	<div ng-controller="myCtrl">
		...
		<button ng-click="nick='개구라'">눌러봐</button> <!-- nick 은 $scope.nick 이라는 의미 -->
		<button ng-click="btnClicked()">눌러봐2</button><!-- btnClicked()은 $scope.btnClicked(); -->
	</div>
	<div ng-controller="yourCtrl">
		<h3>yourCtrl 컨트롤러가 관리하는 영역</h3>
		<p>별명 : <strong ng-bind="nick"></strong></p>
		<button ng-click="nick='원숭이'">눌러봐</button>
		<button ng-mouseover="onMouseover()">마우스를 올려봐</button> <!-- ng-mouseover, mousemove, focus, blur, change, input... -->
	</div>
</body>
</html>
=======
